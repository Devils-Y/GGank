...
public class GlideRoundTransformUtil implements Transformation<Bitmap> {
    ...
    public GlideRoundTransformUtil(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideRoundTransformUtil(BitmapPool pool, int radius, int margin) {
