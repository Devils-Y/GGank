package com.hy.ggank.ui.welfare;
...
import com.hy.ggank.ui.randomdata.RandomDataPresenter;
import com.hy.ggank.ui.randomdata.RandomDataView;
          ...
          if (dataResult.getResults()[0].getUrl() != null) {
               ...
               ImageUtils.getInstance().displayImage(getActivity(),
                         new StringBuffer().append(dataResult.getResults()[0].getUrl())
                                   .append("?imageView2/0/w/").append(dm.widthPixels).toString(), target);
